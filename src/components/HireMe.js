...
const HireMe = () => {
    return(
        <div className="fixed flex items-center justify-center overflow-hidden left-4 bottom-4 md:right-8 sm:right-0 md:left-auto md:top-0 md:bottom-auto md:absolute">
